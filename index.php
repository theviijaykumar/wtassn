<!DOCTYPE html>
    ...
    <body>
        <div class="botron text-center"><h1 style="color: white;">Menu</h1></div>
       

        <div class="dem">
            <h1>Select the menu item for details</h1>
          </div>
        ...
        <footer>
            <!-- <div class="footer1">
                <div class="container-fluid"> -->
                    ...
                    <a href="mailto:vtdeshmukh@mitaoe.ac.in">vtdeshmukh@mitaoe.ac.in</a></p>
                    <!-- </div>
              </div> -->
        </footer>
