<!DOCTYPE html>
    <head>
        <title>Wt Assignment four MITAOE</title>
        <!-- CSS only -->
    ...
    <body>
        <div class="botron text-center"><h1 style="color: white;">Data class php/Restaurant Menu</h1></div>
       

        <div class="dem"><h1 style="color: red;"
            >Select and get your menu details</h1>
          </div>
          
          <div class="box">
            <select name="item restaurant-dropdown restaurant" class="custom-select custom-select-lg mb-3" id="restaurant">
              <option value="">Tap to select menu</option>
          </select>
          <br>
        ...
        <footer>
            <!-- <div class="footer1">
                <div class="container-fluid"> -->
                    ...
                    <a href="mailto:vtdeshmukh@mitaoe.ac.in"> Tap here to Mail vtdeshmukh@mitaoe.ac.in / mo 9890661440</a></p>
                    <!-- </div>
              </div> -->
        </footer>
